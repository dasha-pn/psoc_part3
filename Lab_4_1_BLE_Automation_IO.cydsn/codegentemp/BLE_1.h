...
#define CYBLE_GAP_SECURITY_LEVEL_SECURE_CONN        (3u)
    ...
    #define CYBLE_GAP_SECURITY_LEVEL                (0x03u)
#else
    #if(CYBLE_M0S8BLESS_VERSION_2)
...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_TIMEOUT                  (0x00B4u)
...
*/
#define CYBLE_IO_CAPABILITY                         (CYBLE_GAP_IOCAP_DISPLAY_YESNO)
...
#define CYBLE_SECURITY_LEVEL                        (0x03u)
